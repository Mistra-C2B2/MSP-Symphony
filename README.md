...
2. **Start the development container**
   ...
   - Open the project in a dev container (VS Code should prompt you, or use Command Palette: "Dev Containers: Reopen in Container")
...
3. **Start the backend services**
   ...
   # Deploy the symphony-ws application
   deploy-backend.sh
   ```
...
Your browser will likely show a security warning due to the self-signed certificate. You have two options:

- **Quick option**: Click "Advanced" and "Proceed to 127.0.0.1 (unsafe)"
- **Recommended option**: Add the certificate to your trusted sources for a better development experience

For detailed instructions on adding certificates to your trusted sources, see the certificate configuration guide.
...
The API tests need credentials which are acquired from the four properties _symphony.username_, _symphony.password_,  
_symphony.adminusername_, and _symphony.adminpassword_, whose values need to be set appropriately.
...
production environment. By default it is available at the _/symphony-ws/swagger_ endpoint.~~
